...
// emitter.emit('greet', { name: 'Anna' })
// emitter.emit('greet', { name: 'Sergii' })
// emitter.emit('greet', { name: 'Max' })
...
// const showTextHandler = (text) => {
//     console.log('Text:', text)
// }
// const countLengthHandler = (text) => {
//     console.log('Text length: ', text.length)
// }

// // chat.on('message', (t) => console.log('Text:', t))
// // chat.on('message', (t) => console.log('Text length: ', t.length))
// chat.on('message', showTextHandler)
// chat.on('message', countLengthHandler)
// chat.send('Hello')
...
// fs.writeFile('note.txt', 'Node.js', (err) => {
//     if(err) {
//         console.error("Error ocurred writing file: ", err)
//         return
//     }
//     console.log('File note.txt was successfully written');

//     fs.readFile('note.txt', 'utf-8', (err, data) => {
//         if(err) {
//             console.error("Error ocurred reading file: ", err)
//             return
//         }
